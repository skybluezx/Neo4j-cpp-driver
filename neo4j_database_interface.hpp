...
//  image_system
//
//  Created by skyblue on 15/10/5.
//  Copyright © 2015年 skyblue. All rights reserved.
//

#ifndef database_interface_new4j_interface_h
#define database_interface_new4j_interface_h
...
#include "../database_driver/neo4j.hpp"

namespace databaseInterface
{
    class Neo4jDatabaseInterface
    {
    public:
        ...
        //构造方法
        Neo4jDatabaseInterface(std::shared_ptr<databaseDriver::Neo4j> database);
        
        //构造方法
        Neo4jDatabaseInterface(std::shared_ptr<databaseDriver::Neo4j> database, std::string host, std::string port, std::string user, std::string password);
...
//        Json::Value selectRelationshipsByTypeAndProperties(std::string type, Json::Value &properties);
    ...
    private:
        std::shared_ptr<databaseDriver::Neo4j> database;
...
#endif /* database_interface_new4j_interface_h */
